      ...
      <div className="page-container">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <button
              onClick={toggleTheme}
              className="p-2 rounded-lg text-slate-400 hover:text-slate-900 hover:bg-dark-600 transition-colors"
        ...
        {menuOpen && (
          <div className="md:hidden border-t border-dark-500 py-3 space-y-1">
            ...
            {user ? (
              <button
                onClick={handleLogout}
                className="w-full text-left px-4 py-2 text-red-400 hover:bg-red-900/20 rounded-lg"
              >
                Logout
              </button>
            ) : (
