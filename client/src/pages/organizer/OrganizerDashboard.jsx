...
function EventFormModal({ event, onClose, onSuccess, isAdmin, organizers }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        price_eur: form.price_eur === "" ? 0 : parseFloat(form.price_eur),
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, price_eur: e.target.value })
                }
              />
            </div>
            ...
            <div className="sm:col-span-2">
              ...
              <div className="flex gap-3 items-center">
                ...
                />
                <label
                  className={`btn-secondary cursor-pointer text-sm ${uploading ? "opacity-50 cursor-wait" : ""}`}
                >
...
export default function OrganizerDashboard() {
  ...
  const { data: organizers = [] } = useQuery({
    queryKey: ["organizers"],
    queryFn: eventsService.getOrganizers,
    enabled: isAdmin,
  });
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-slate-100">
            {isAdmin ? "Event Management" : "Organizer Dashboard"}
          </h1>
          <p className="text-slate-400 mt-1">
            {isAdmin ? "Manage all events" : "Manage your events"}
          </p>
        </div>
        <button
          onClick={() => {
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-dark-500">
                  ...
                  <th className="text-left p-4 text-sm font-medium text-slate-400 hidden md:table-cell">
                    Tickets
                  </th>
                  <th className="text-left p-4 text-sm font-medium text-slate-400">
                    Status
