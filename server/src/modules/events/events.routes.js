...
router.get("/", (req, res, next) =>
  eventsController.listEvents(req, res, next),
);
...
router.get(
  ...
  (req, res, next) => eventsController.getOrganizerEvents(req, res, next),
);
...
router.patch(
  "/:id/publish",
  requireRoles("organizer", "admin"),
  (req, res, next) => eventsController.publishEvent(req, res, next),
);

router.patch(
  "/:id/cancel",
  requireRoles("organizer", "admin"),
  (req, res, next) => eventsController.cancelEvent(req, res, next),
);
